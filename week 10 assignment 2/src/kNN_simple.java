...
public class kNN_simple 
{
 public static void main(String[] args) throws IOException 
 {
     ...
     int TRAIN_SIZE=50; //no. training patterns 
     int VAL_SIZE=50; //no. testing patterns 
     int FEATURE_SIZE=100; //no. of features
     ...
     String val_file="ovari_val_data.txt"; //read training data
    ...
    String val_label_file="ovari_val_label.txt"; //read train label
    ...
    //  int[] neighbor = new int[NUM_NEIGHBOR];
     ...
     double[] accuracyList = new double[20];
