...
public class kNN_GA_simple {

     public static int TRAIN_SIZE=50; //no. training patterns 
     public static int VAL_SIZE=50; //no. validation patterns 
     public static int FEATURE_SIZE=100; //no. of features
  ...
  public static void Load_Data(int TRAIN_SIZE, int VAL_SIZE, int FEATURE_SIZE) throws IOException {
    ...
    String train_file="ovari_train_data.txt"; //read training data
    ...
    String val_file="ovari_val_data.txt"; //read validation data
    ...
    String train_label_file="ovari_train_label.txt"; //read train label
    ...
    String val_label_file="ovari_val_label.txt"; //read validation label (to obtain classification accuracy)
  ...
  public static boolean[] GA() { 
    ...
    int POP_SIZE=1000; //population size - for assignment, see brief for limit
    int MAX_GEN=100; //maximum generation - for assignment, see brief for limit
    ...
    System.arraycopy(sol, 0, new_sol, 0, sol.length);  
  ...
  public static double KNN(double[][] train, double[][] val, int[] train_label, int[] val_label, boolean[] sol) {
    ...
    int NUM_NEIGHBOUR = 1; //replace with optimal k value
